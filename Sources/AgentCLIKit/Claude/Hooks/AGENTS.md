...
- Scope hook tokens to one harness launch and invalidate them when that launch exits or is superseded.
...
- Keep HTTP parsing and listener lifecycle here; keep generic runtime APIs harness-neutral where possible.
