...
extension CodexHarnessAdapterRuntimeTests {
    func configuration(
    ...
    func runtimeContext(threadId: AgentSessionID, spawnConfig: AgentSpawnConfig) -> AgentHarnessRuntimeContext {
        runtimeContext(
            threadId: threadId,
    ...
    func interruptContext(threadId: AgentSessionID, spawnConfig: AgentSpawnConfig) -> AgentHarnessInterruptContext {
        AgentHarnessInterruptContext(
            conversationId: "conversation",
            processToken: fixedProcessToken,
            harnessSessionId: threadId,
            spawnConfig: spawnConfig
