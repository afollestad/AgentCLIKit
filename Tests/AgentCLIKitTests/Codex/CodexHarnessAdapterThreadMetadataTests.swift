...
final class CodexHarnessAdapterThreadMetadataTests: XCTestCase {
    ...
    private func runtimeContext(threadId: AgentSessionID, spawnConfig: AgentSpawnConfig) -> AgentHarnessRuntimeContext {
    ...
    private static func collect(_ stream: AsyncStream<AgentHarnessRuntimeEvent>, count: Int) async -> [AgentHarnessRuntimeEvent] {
