...
extension ClaudeProviderAdapterTests {
    func testInitializerAcceptsHostOwnedApprovalPolicyStore() async throws {
        ...
        let adapter = ClaudeProviderAdapter(approvalPolicyStore: approvalPolicyStore, hookSupportDirectory: directory)
        addTeardownBlock {
        ...
        let launch = try await adapter.prepareLaunchConfiguration(
            ...
            spawnConfig: AgentSpawnConfig(providerId: .claude, workingDirectory: directory, permissionMode: "default"),
